    ...
    <body>
        ...
        <div class="big-body">
            <div class="body-top">
                ...
                <a href="./info"><img src="{{ asset('image/lp_instagram_job.png') }}" class="wide"></a>
            ...
            <div class="big-body-main">
                ...
                <div class="body-main-3">
                    ...
                    <a href="./info"><img src="{{ asset('image/popo-2.jpg') }}" class="wide"></a>
                    ...
                    <div class="body-button">
                        ...
                        <a href="./info" class="btn-square-shadow"><i class="fab fa-apple"></i> 詳細はコチラ <i class="fas fa-arrow-circle-right"></i></a>
                        <br>
                        <br>
