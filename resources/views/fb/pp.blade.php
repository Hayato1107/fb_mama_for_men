...
<html>
    <head>
        ...
        <link href="{{ secure_asset('css/pp.css') }}" rel="stylesheet">
    ...
    <body>
        ...
        <a href="https://lin.ee/Irm6TMK" target="_blank" class="btn-square-little-rich"><img src="{{ asset('image/line_friend_add.png') }}"></img></a>
        <br>
        <br>
        <div class="button">
